...
func Profil_comment(w http.ResponseWriter, r *http.Request, database db.Db) {
	//checking session
	...
	fmt.Println("--------------------------------------------")
	fmt.Println("             Profil-comment form value             ")
	fmt.Println("--------------------------------------------")
	...
	fmt.Println("--------------- 🟢🌐 profil-comment data sent -----------------------") //debug
}
